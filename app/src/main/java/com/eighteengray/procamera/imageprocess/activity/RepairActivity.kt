...
class RepairActivity: BaseActivity() {
    ...
    private fun initView() {
        var width = ScreenUtils.getScreenWidth(this@RepairActivity)
        ...
        binding.ivBack.setOnClickListener {
            ...
            val file: File = FileUtils.createFile(
                SDCardUtils.getAppFile(this@RepairActivity).absolutePath,
                "cutBitmap.jpg"
            )
            path = file.absolutePath
            ImageUtils.saveBitmap2Album(this@RepairActivity, cutBitmap)
