...
class BlurActivity: BaseActivity() {
    ...
    private fun initView() {
        var width = ScreenUtils.getScreenWidth(this@BlurActivity)
        ...
        binding.ivBack.setOnClickListener {
            ...
            val file: File = FileUtils.createFile(
                SDCardUtils.getAppFile(this@BlurActivity).absolutePath,
                "cutBitmap.jpg"
            )
            path = file.absolutePath
            ImageUtils.saveBitmap2Album(this@BlurActivity, cutBitmap)
